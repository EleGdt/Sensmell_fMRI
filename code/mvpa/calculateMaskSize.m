...
% conditions are named 'olfaWords', 'nonOlfaWords', 'olfaPictures', 'nonOlfaPictures' 


% classify 'olfaWords_vs_nonOlfaWords','olfaPictures_vs_nonOlfaPictures'
...
%   condLabelNb = [1 2 3 4];
  condLabelName = {'olfaWords', 'nonOlfaWords', 'olfaPictures','nonOlfaPictures'};
  decodingConditionList = {'olfaWords_vs_nonOlfaWords', 'olfaPictures_vs_nonOlfaPictures'}; % or OlfaPicture_vs_NonOlfaPicture
  ...
  for iSub = 1:numel(opt.subjects)
    ...
    if strcmp(subID,'002')==1 || strcmp(subID,'003')==1 || strcmp(subID,'004')==1
        nbRun=9;
